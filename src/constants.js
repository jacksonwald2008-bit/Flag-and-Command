...
// Formation geometry
export const SOLDIER_SPACING = 4.0;  // meters between soldiers in a rank
export const RANK_DEPTH      = 8.0;  // meters between ranks
...
export const DEPLOY_ZONE_PLAYER = { y: WORLD_H - 460, h: 440, x: 30, w: 1440 };
export const DEPLOY_ZONE_AI     = { y: 10,             h: 440, x: 30, w: 1440 };
