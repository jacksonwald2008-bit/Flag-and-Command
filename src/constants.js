...
// Formation geometry
export const SOLDIER_SPACING = 1.0;  // meters between soldiers in a rank
...
export const DEPLOY_ZONE_PLAYER = { y: WORLD_H - 120, h: 110, x: 200, w: 1100 };
export const DEPLOY_ZONE_AI     = { y: 10,             h: 110, x: 200, w: 1100 };
